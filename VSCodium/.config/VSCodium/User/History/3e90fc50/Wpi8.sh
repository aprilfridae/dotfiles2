...
# Force GTK to re-read files
if command -v xsettingsd >/dev/null; then
    # Get your actual current theme name
    CURRENT_THEME=$(gsettings get org.gnome.desktop.interface gtk-theme | tr -d "'")
    
    # We broadcast a "dummy" change to Adwaita, then back to your theme
    # This 'jiggles the handle' and forces apps to repaint
